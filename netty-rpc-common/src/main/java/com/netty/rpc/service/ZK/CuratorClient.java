package com.netty.rpc.service.ZK;
...
public class CuratorClient {
  ...
  public CuratorClient(String connectString) {
    this(connectString, ZKConstant.ZK_NAMESPACE, ZKConstant.ZK_SESSION_TIMEOUT,
        ZKConstant.ZK_CONNECTION_TIMEOUT);
  }
  ...
  public void watchPathChildrenNode(String path, PathChildrenCacheListener listener)
      throws Exception {
